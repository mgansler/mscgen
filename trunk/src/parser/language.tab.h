...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     TOK_REL_SIG_TO = 277,
     TOK_REL_SIG_FROM = 278,
     TOK_REL_METHOD_TO = 279,
     TOK_REL_METHOD_FROM = 280,
     TOK_REL_RETVAL_TO = 281,
     TOK_REL_RETVAL_FROM = 282,
     TOK_REL_DOUBLE_TO = 283,
...
#define TOK_REL_SIG_TO 277
#define TOK_REL_SIG_FROM 278
#define TOK_REL_METHOD_TO 279
#define TOK_REL_METHOD_FROM 280
#define TOK_REL_RETVAL_TO 281
#define TOK_REL_RETVAL_FROM 282
#define TOK_REL_DOUBLE_TO 283
